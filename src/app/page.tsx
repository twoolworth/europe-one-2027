...
export default function Home() {
    return (
        <div className="bg-[#1D1D1A] min-h-screen text-white">
            ...
            <main>
                <section
                    className="hero pt-24 pb-12 md:pt-32 md:pb-24 bg-[#1D1D1A] bg-opacity-60 bg-no-repeat bg-cover bg-center bg-blend-multiply"
                    style={{ backgroundImage: 'url("/harry-borrett-dxjCk3nO9pY-unsplash.jpg")' }}>
                    <div className="container mx-auto px-4 text-center">
                        <Image src="/RTI-logo-rondel-100.png" alt="Round Table International Logo" width={150} height={150} className="mx-auto mb-8" />
